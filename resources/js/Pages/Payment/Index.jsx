...
export default function PaymentIndex({ user, subscription, whatsappNumber, plans }) {
    const defaultPlans = {
        basico: { name: 'Básico', price: 50, max_properties: 5, can_featured: false },
        profesional: { name: 'Profesional', price: 150, max_properties: 20, can_featured: true },
        enterprise: { name: 'Enterprise', price: 500, max_properties: 100, can_featured: true }
    };
    ...
    return (
        <AppLayout>
                    ...
                    {Object.entries(defaultPlans).map(([key, plan]) => (
                        ...
                        >
                            ...
                            <Link
                                ...
                                className="w-full block bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-lg text-center transition-colors"
                            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-orange-50 rounded-lg p-6 border-2 border-orange-300">
                        ...
                        <p className="text-orange-800 mb-4">
                            Encontraste un error? Cuéntanos los detalles
                        </p>
                        <form action={route('payment.report')} method="POST" className="inline">
            ...
            <section className="text-center py-12 bg-gray-100">
                ...
                <Link
                    href={route('payment.subscription', { plan: 'basico' })}
