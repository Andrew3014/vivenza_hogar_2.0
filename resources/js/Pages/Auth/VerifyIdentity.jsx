...
export default function VerifyIdentity({ verification = null }) {
    ...
    const handleSubmit = () => {
        ...
        router.post('/verification/submit', {
            ...
            onError: (errors) => {
                setError(errors.message || 'No se pudo enviar la verificación. Inténtalo nuevamente.');
            },
                ...
                <div className="max-w-2xl mx-auto px-4">
                    ...
                    {verification?.status === 'aprobado' && (
                        <div className="mb-8 bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                            ...
                            <h2 className="text-xl font-bold text-green-800 mb-1">Verificación aprobada</h2>
                            <p className="text-green-700">
                                Tu identidad ya está verificada. Vendedores y compradores pueden ver tu estado de confianza.
                            </p>
                        </div>
                    )}
                    ...
                    {verification?.status === 'pendiente' && (
                        <div className="mb-8 bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
                            <div className="text-5xl mb-3">⏳</div>
                            <h2 className="text-xl font-bold text-blue-800 mb-1">Verificación en revisión</h2>
                            <p className="text-blue-700">
                                Ya enviaste tus fotos. Nuestro equipo las revisará y te notificará el resultado en 24-48 horas.
                            </p>
                        </div>
                    )}
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600">
                            ...
                            La verificación se realiza únicamente con la cámara de tu equipo; no se aceptan imágenes subidas.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        <ol className="flex items-center gap-2">
                            {[
                                { n: 1, label: 'Documento frente' },
                                { n: 2, label: 'Documento reverso' },
                                { n: 3, label: 'Selfie' },
                                { n: 4, label: 'Revisar' },
                            ].map(s => (
                                <li key={s.n} className="flex-1">
                                    <button
                                        ...
                                        className={`w-full text-left group ${
                                            s.n >= step ? 'cursor-default' : 'cursor-pointer'
                                        }`}
                                    >
                                        <span
                                            className={`block h-2 rounded-full transition-colors ${
                                                s.n <= step ? 'bg-blue-600' : 'bg-gray-300'
                                            }`}
                                        />
                                        <span
                        ...
                        <div className="mb-6">
                            {step === 1 && (
                                <CameraCapture
                                    ...
                                    description="Toma una foto clara del frente de tu cédula de identidad usando la cámara. Asegúrate que toda la información sea visible."
                            ...
                            {step === 2 && (
                                <CameraCapture
                                    ...
                                    description="Ahora toma una foto del reverso de tu cédula de identidad usando la cámara."
                                    cameraMode="environment"
                                />
                            )}
                            ...
                            {step === 3 && (
                                <CameraCapture
                                    ...
                                    description="Toma un selfie claro con la cámara frontal donde se vea tu rostro y coincida con la foto de tu cédula."
                                    cameraMode="user"
                                />
                            )}
