...
export default function UpdatePasswordForm({ className = '' }) {
    ...
    return (
        <section className={`vz-form-section ${className}`}>
            <header>
                <h2 className="vz-form-title">Seguridad</h2>
            ...
            <form onSubmit={updatePassword} className="vz-form-grid">
                <div>
                    <InputLabel
                        htmlFor="current_password"
                        value="Contraseña actual"
                        className="vz-form-label"
                    />
                    ...
                    <InputError
                        ...
                        className="vz-form-error"
                    />
                </div>

                <div>
                    <InputLabel htmlFor="password" value="Nueva contraseña" className="vz-form-label" />
