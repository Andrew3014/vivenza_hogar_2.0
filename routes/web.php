...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('/panel', [PropertyController::class, 'userProperties'])->name('dashboard');
    ...
    Route::get('/pago/propiedad/{propertyId}', [PaymentController::class, 'contactProperty'])->name('payment.property');
...
Route::middleware(['auth', 'verified', 'role:agente'])->group(function () {
    Route::prefix('agent')->name('agent.')->group(function () {
        ...
        Route::post('/mensajes/{inquiry}/responder', [InquiryController::class, 'reply'])->name('messages.reply');
        Route::post('/mensajes/{inquiry}/estado', [InquiryController::class, 'markAsResponded'])->name('messages.status');
    });
});
